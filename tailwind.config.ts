	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Custom colors for the antique theme
				gold: {
					light: '#d4b174',
					DEFAULT: '#c4a256',
					dark: '#a38547'
